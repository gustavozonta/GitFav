...
export class FavoritesView extends Favorites {
  ...
  onadd() {
    const addButton = this.root.querySelector(".container button")
    addButton.onclick = () => {
      const { value } = this.root.querySelector(".container input")
  ...
  createRow(user) {
    ...
    tr.innerHTML = `
    <td class="user">
      <img src="https://github.com/${user.login}.png" alt="Image from ${user.name}">
